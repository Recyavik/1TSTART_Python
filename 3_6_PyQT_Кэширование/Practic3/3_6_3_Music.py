...
class Window(QMainWindow):
    def __init__(self):
        ...
        # Используется для изменения, чтобы уведомить self.update о том, что индекс списка воспроизведения изменился.
        ...
        container.addWidget(self.my_header_footer(100, 100, 24,
                                                'МОЯ МУЗЫКА C PYQT'), 0, 0, 1, 3)
        ...
        container.addWidget(self.my_header_footer(40, 40, 12,
                                                '1T Музыкальный проигрыватель на курсе НЕЙРО.PY'), 4, 0, 1, 3)
