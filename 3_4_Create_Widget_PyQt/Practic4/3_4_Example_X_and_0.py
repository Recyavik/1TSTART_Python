...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QLabel,
                             ...
                             QLineEdit, QSizePolicy, QMessageBox, QWidget, QPushButton)
...
class GameX0:
    ...
    def check(self, player="0"):
        ...
        and self.table_game[2,2] == player) or
            (self.table_game[0,2] == player and self.table_game[1,1] == player and
        self.table_game[2,0] == player)):
            result = True
        return result
...
class MainWindow(QMainWindow, QWidget):
    ...
    def new_game(self):
        (QMessageBox.information(self, "Новая игра",
                                 "Первый ход крестиком играет: "
                                 + self.game.game_name_player2))
        self.turn = True
        self.game.new()
        for key in self.game_buttons.keys():
